...
from kafka_msgs import consumertask, producertask, rest
...
class EventStreamsSample(object):
    ...
    def __init__(self, args):
        ...
        self.opts['sevone_name'] = os.getenv("SEVONE_USER")
        self.opts['sevone_password'] = os.getenv("SEVONE_PASSWORD")
    ...
    def run_tasks(self):
        ...
        if self.run_consumer:
            self.consumer = consumertask.ConsumerTask(consumer_opts, self.opts['topic_name'], self.opts['sevone_name'], self.opts['sevone_password'])
